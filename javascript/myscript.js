...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Hồi hộp ghê..." + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Hồi hộp như vậy là vì';
document.querySelector('.Description .modal-body').innerHTML = 'Mai thi rùi <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";
author.innerHTML = "Bản quyền thuộc về<a href='https://www.facebook.com/hoang.chelsea.353'>Hoàng Vũ<a>";
